...
type ProjectDocumentDataSlicesSlice = ImgaeBlockSlice | TextBlockSlice;
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.view_more
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Primary content in *ImgaeBlock → Default → Primary*
 */
export interface ImgaeBlockSliceDefaultPrimary {
  /**
   * Image field in *ImgaeBlock → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: imgae_block.default.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Default variation for ImgaeBlock Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ImgaeBlockSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ImgaeBlockSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ImgaeBlock*
 */
type ImgaeBlockSliceVariation = ImgaeBlockSliceDefault;

/**
 * ImgaeBlock Shared Slice
 *
 * - **API ID**: `imgae_block`
 * - **Description**: ImgaeBlock
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ImgaeBlockSlice = prismic.SharedSlice<
  "imgae_block",
  ImgaeBlockSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      ImgaeBlockSlice,
      ImgaeBlockSliceDefaultPrimary,
      ImgaeBlockSliceVariation,
      ImgaeBlockSliceDefault,
      TechListSlice,
